...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-body mb-4">
                <h2 class="card-title">Pending Deposit Transactions</h2>
                @forelse (auth()->user()->pending_tids()->latest()->take(10)->get() as $transaction)
                    <div class="card shadow-lg mb-2">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex flex-column">
                                    <h4 class="mb-2 {{ $transaction->sum ? 'text-success' : 'text-danger' }}">
                                        ${{ number_format($transaction->amount, 2) }}</h4>
                                    <h4 class="text-uppercase mb-0">Pending Deposit</h4>
                                    <p class="text-uppercase mb-0"><small>{{ $transaction->reference }}</small></p>
                                </div>
                                <div class="text-end">
                                    <h6 class="text-uppercase mb-2">{{ $transaction->created_at }}</h6>
                ...
                @empty
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="text-success">NO Pending Deposit</h4>
                            </div>
                        </div>
                    </div>
                @endforelse
