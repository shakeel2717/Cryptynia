    ...
    <div class="card">
        <div class="card-body p-sm-5 m-lg-4">
            <div class="text-center mt-2">
                <h2 class="mb-3 text-uppercase">{{ env('APP_NAME') }}</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="refer" id="refer" placeholder="Referral Username"
                                        class="form-control" value="{{ old('refer', $refer) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="code">Select Country</label>
